...
(function () {
    ...
    Body.getAngularVelocity = function (body) {
        return (
            ((body.angle - body.anglePrev) * Common._timeUnit) / body.deltaTime
        );
    };
    ...
    Body.update = function (body, deltaTime) {
        deltaTime =
            (typeof deltaTime !== "undefined" ? deltaTime : Common._timeUnit) *
            body.timeScale;
